    ...
    <script>
        $(function(){
            ...
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src","${path}/yxAdmin/checkCode?d="+new Date().getTime());
            });
            /* 表单验证 自定义提示*/
            $.extend($.validator.messages, {
                required: "<span style='color: red;padding-left: -6px'>必填</span>",//提示信息
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="username" minlength="4" placeholder="请输入用户名..." class="form-username form-control" required id="form-username">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="form-password">Password</label>
                                <input type="password" name="password" minlength="3" placeholder="请输入密码..." class="form-password form-control" required id="form-password">
                            </div>
                            <div class="form-group">
                                <%--<label class="sr-only" for="form-code">Code</label>--%>
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/yxAdmin/checkCode">
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required minlength="4" type="text" name="enCode" id="form-code">
                            </div>
